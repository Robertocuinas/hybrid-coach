...
test("las migraciones 0001-0008 se aplican en orden sobre una base vacía", async () => {
  ...
  assert.deepEqual(result.rows[0], { state_time: true, one_active: true, role_check: true, ai_settings: true });
  await db.close();
});

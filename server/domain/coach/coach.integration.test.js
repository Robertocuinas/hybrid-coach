...
test("buildContext arma bloques separados y solo con datos de la ventana", async () => {
  ...
  for (const encabezado of ["DATOS DEL ATLETA", "ESTADO ACTUAL", "PLAN VIGENTE", "REGLAS DE DISTRIBUCIÓN", "EVIDENCIA RECUPERADA", "CÓMO RESPONDES"]) {
  ...
  assert.ok(system.includes("no lo recalcules"), "el plan se presenta como cerrado");
